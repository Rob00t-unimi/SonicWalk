...
class MyWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        app.setStyleSheet(open(self.currentThemeCss).read())
    ...
    def setup_side_frame(self):
        ...
        self.sideFrame.setStyleSheet("background-color: lightgray;")
    ...
    def setup_hamburger_button(self):
        self.hamburger_button = self.create_button(self.icon_path + "menu.svg")
    ...
    def setup_inner_frame1(self):
        ...
        self.buttonAnalysis = self.create_button(self.icon_path + "activity.svg")
        self.buttonAnalysis.clicked.connect(self.buttonAnalysis_clicked)
        self.buttonArchive = self.create_button(self.icon_path + "archive.svg")
        self.buttonArchive.clicked.connect(self.buttonArchive_clicked)
        self.buttonStatistics = self.create_button(self.icon_path + "bar-chart-2.svg")
        self.buttonStatistics.clicked.connect(self.buttonStatistics_clicked)
        self.buttonSettings = self.create_button(self.icon_path + "settings.svg")
    ...
    def setup_inner_frame2(self):
        ...
        self.theme_button = self.create_button(self.icon_path + "moon.svg")
        self.theme_button.clicked.connect(self.toggle_theme)
        self.buttonInfo = self.create_button(self.icon_path + "info.svg")
    ...
    def setup_main_widget(self):
        ...
        # Di default partiamo con analysis page
        layout.addWidget(self.analysisPage.get_frame())
        # layout.addWidget(self.archivePage.get_frame())
        # layout.addWidget(self.settingsPage.get_frame())
        # layout.addWidget(self.statisticsPage.get_frame())
    ...
    def update_menu(self):
        self.sideFrame.setFixedWidth(150 if self.menu_expanded else 60)
        button_list = [
    ...
    def toggle_theme(self):
        ...
        self.currentThemeCss, self.icon_path = self.theme_manager.toggle_theme()
        app.setStyleSheet(open(self.currentThemeCss).read())
        self.reload_icons()
